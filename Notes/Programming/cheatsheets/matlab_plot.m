...
text(1,0.98,'''color''','HorizontalAlignment','right','VerticalAlignment','top','FontSize',ftsz*12,'FontName','consolas','color',[160 32 240] / 256)
...
text(0   +0.04, 0.07,'''y''','HorizontalAlignment','center','VerticalAlignment','bottom','FontSize',ftsz*11,'FontName','consolas','color',[160 32 240] / 256)
text(0.12+0.04, 0.07,'''m''','HorizontalAlignment','center','VerticalAlignment','bottom','FontSize',ftsz*11,'FontName','consolas','color',[160 32 240] / 256)
text(0.24+0.04, 0.07,'''c''','HorizontalAlignment','center','VerticalAlignment','bottom','FontSize',ftsz*11,'FontName','consolas','color',[160 32 240] / 256)
text(0.36+0.04, 0.07,'''r''','HorizontalAlignment','center','VerticalAlignment','bottom','FontSize',ftsz*11,'FontName','consolas','color',[160 32 240] / 256)
text(0.48+0.04, 0.07,'''g''','HorizontalAlignment','center','VerticalAlignment','bottom','FontSize',ftsz*11,'FontName','consolas','color',[160 32 240] / 256)
text(0.60+0.04, 0.07,'''b''','HorizontalAlignment','center','VerticalAlignment','bottom','FontSize',ftsz*11,'FontName','consolas','color',[160 32 240] / 256)
text(0.72+0.04, 0.07,'''w''','HorizontalAlignment','center','VerticalAlignment','bottom','FontSize',ftsz*11,'FontName','consolas','color',[160 32 240] / 256)
text(0.84+0.04, 0.07,'''k''','HorizontalAlignment','center','VerticalAlignment','bottom','FontSize',ftsz*11,'FontName','consolas','color',[160 32 240] / 256)
xlim([0 1])
ylim([0 1])
xticks([])
yticks([])
...
text(1,0.98,'''marker''','HorizontalAlignment','right','VerticalAlignment','top','FontSize',ftsz*12,'FontName','consolas','color',[160 32 240] / 256)
...
text(0   +0.03, 0.07,'''o'''   ,'HorizontalAlignment','center','VerticalAlignment','bottom','FontSize',ftsz*11,'FontName','consolas','color',[160 32 240] / 256)
text(0.07+0.03, 0.07,'''+'''   ,'HorizontalAlignment','center','VerticalAlignment','bottom','FontSize',ftsz*11,'FontName','consolas','color',[160 32 240] / 256)
text(0.14+0.03, 0.07,'''*'''   ,'HorizontalAlignment','center','VerticalAlignment','bottom','FontSize',ftsz*11,'FontName','consolas','color',[160 32 240] / 256)
text(0.21+0.03, 0.07,'''.'''   ,'HorizontalAlignment','center','VerticalAlignment','bottom','FontSize',ftsz*11,'FontName','consolas','color',[160 32 240] / 256)
text(0.28+0.03, 0.07,'''x'''   ,'HorizontalAlignment','center','VerticalAlignment','bottom','FontSize',ftsz*11,'FontName','consolas','color',[160 32 240] / 256)
text(0.35+0.03, 0.07,'''s'''   ,'HorizontalAlignment','center','VerticalAlignment','bottom','FontSize',ftsz*11,'FontName','consolas','color',[160 32 240] / 256)
text(0.42+0.03, 0.07,'''d'''   ,'HorizontalAlignment','center','VerticalAlignment','bottom','FontSize',ftsz*11,'FontName','consolas','color',[160 32 240] / 256)
text(0.49+0.03, 0.07,'''\^'''   ,'HorizontalAlignment','center','VerticalAlignment','bottom','FontSize',ftsz*11,'FontName','consolas','color',[160 32 240] / 256)
text(0.56+0.03, 0.07,'''v'''   ,'HorizontalAlignment','center','VerticalAlignment','bottom','FontSize',ftsz*11,'FontName','consolas','color',[160 32 240] / 256)
text(0.63+0.03, 0.07,'''>'''   ,'HorizontalAlignment','center','VerticalAlignment','bottom','FontSize',ftsz*11,'FontName','consolas','color',[160 32 240] / 256)
text(0.70+0.03, 0.07,'''<'''   ,'HorizontalAlignment','center','VerticalAlignment','bottom','FontSize',ftsz*11,'FontName','consolas','color',[160 32 240] / 256)
text(0.77+0.03, 0.07,'''p'''   ,'HorizontalAlignment','center','VerticalAlignment','bottom','FontSize',ftsz*11,'FontName','consolas','color',[160 32 240] / 256)
text(0.84+0.03, 0.07,'''h'''   ,'HorizontalAlignment','center','VerticalAlignment','bottom','FontSize',ftsz*11,'FontName','consolas','color',[160 32 240] / 256)
text(0.91+0.03, 0.07,'''none''','HorizontalAlignment','center','VerticalAlignment','bottom','FontSize',ftsz*11,'FontName','consolas','color',[160 32 240] / 256)
xlim([0 1])
ylim([0 1])
xticks([])
yticks([])
...
text(1,0.98,'''markersize''','HorizontalAlignment','right','VerticalAlignment','top','FontSize',ftsz*12,'FontName','consolas','color',[160 32 240] / 256)
...
text(1,0.98,'''linewidth''','HorizontalAlignment','right','VerticalAlignment','top','FontSize',ftsz*12,'FontName','consolas','color',[160 32 240] / 256)
...
text(1,0.98,'''linestyle''','HorizontalAlignment','right','VerticalAlignment','top','FontSize',ftsz*12,'FontName','consolas','color',[160 32 240] / 256)
...
text(     0.125, 0.07,'''-''','HorizontalAlignment','center','VerticalAlignment','bottom','FontSize',ftsz*11,'FontName','consolas','color',[160 32 240] / 256)
text(0.25+0.125, 0.07,'''--''','HorizontalAlignment','center','VerticalAlignment','bottom','FontSize',ftsz*11,'FontName','consolas','color',[160 32 240] / 256)
text(0.50+0.125, 0.07,''':''','HorizontalAlignment','center','VerticalAlignment','bottom','FontSize',ftsz*11,'FontName','consolas','color',[160 32 240] / 256)
text(0.75+0.125, 0.07,'''-.''','HorizontalAlignment','center','VerticalAlignment','bottom','FontSize',ftsz*11,'FontName','consolas','color',[160 32 240] / 256)
xlim([0 1])
ylim([0 1])
xticks([])
yticks([])
...
text(0.73,0.82,'Frame','Units','normalized','VerticalAlignment','top',...
    'HorizontalAlignment','right','FontSize',ftsz*30,'color',[170 170 170] / 256)
...
text(0.72,0.9,'''VerticalAlignment''','FontName','consolas','HorizontalAlignment','center','FontSize',ftsz*10,'color',[160 32 240] / 256)
text(0.28,0.85,'''HorizontalAlignment''','FontName','consolas','HorizontalAlignment','center','FontSize',ftsz*10,'color',[160 32 240] / 256)
...
text(0.28,0.15+2*0.25,'''left''','HorizontalAlignment','left','FontSize',ftsz*13,'color',[160 32 240] / 256,'fontname','consolas')
text(0.72,0.15+2*0.25,'''middle''','VerticalAlignment','middle','FontSize',ftsz*13,'color',[160 32 240] / 256,'fontname','consolas')
text(0.28,0.15+1*0.25,'''center''','HorizontalAlignment','center','FontSize',ftsz*13,'color',[160 32 240] / 256,'fontname','consolas')
text(0.72,0.15+1*0.25,'''top''','VerticalAlignment','top','FontSize',ftsz*13,'color',[160 32 240] / 256,'fontname','consolas')
text(0.28,0.15+0*0.25,'''right''','HorizontalAlignment','right','FontSize',ftsz*13,'color',[160 32 240] / 256,'fontname','consolas')
text(0.72,0.15+0*0.25,'''bottom''','VerticalAlignment','bottom','FontSize',ftsz*13,'color',[160 32 240] / 256,'fontname','consolas')
...
text(0,-0.03,"colormap(ax,name)",'Units','normalized','VerticalAlignment','bottom',...
        'FontName','consolas','FontSize',ftsz*12,'color',[160 32 240] / 256)
